...
# How to Add Instructions to Your Support Monkey AI Chatbot Agent in Copilot Studio
...
## 3. Select Your Support Monkey Agent
   - From the list of available agents, select your **Support Monkey Agent** (or create a new one if you haven't yet).
